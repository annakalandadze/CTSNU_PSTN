...
public class LiteralTest {
	...
	public final void testParse() {
		final Literal a = Literal.parse("a");
		final Literal notA = Literal.parse("¬a");
		final Literal unkA = Literal.parse("¿a");
...
//		assertEquals(0, unkA.compareTo(unkA));
	...
	public final void testGetComplement() {
		final Literal a = Literal.parse("a");
		final Literal notA = a.getComplement();

		final Literal unA = Literal.valueOf('a', Literal.UNKNOWN);

		assertNotEquals(notA, a);
		assertNull(unA.getComplement());
	}
	...
	public final void testToString() {
		final Literal a = Literal.parse("a");
		final Literal notA = Literal.parse("¬a");
		final Literal unkA = Literal.valueOf('a', Literal.UNKNOWN);
